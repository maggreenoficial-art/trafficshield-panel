...
class AsciiFilter {
  ...
  constructor(renderer: THREE.WebGLRenderer, { fontSize, fontFamily, charset, invert, blendMode, enableHueRotation }: AsciiFilterOptions = {}) {
    ...
    this.enableHueRotation = enableHueRotation ?? true;
  ...
  reset() {
    if (this.context) {
      ...
      this.pre.style.backgroundAttachment = this.enableHueRotation ? 'fixed' : 'scroll';
  ...
  hue() {
    if (!this.enableHueRotation) return;
...
class CanvAscii {
  ...
  constructor(
    { text, asciiFontSize, textFontSize, textColor, planeBaseHeight, enableWaves, variant = 'default' }: CanvAsciiOptions,
  ...
  setRenderer() {
    ...
    this.filter = new AsciiFilter(this.renderer, {
      ...
      invert: true,
      blendMode: this.variant === 'logo' ? 'normal' : 'difference',
      enableHueRotation: this.variant !== 'logo'
    });
  ...
  useEffect(() => {
    ...
    const createAndInit = async (container: HTMLDivElement, w: number, h: number) => {
      const instance = new CanvAscii(
        { text, asciiFontSize, textFontSize, textColor, planeBaseHeight, enableWaves, variant },
        container,
        w,
        h
      );
  ...
  return (
    ...
    >
      <style>{`
        ...
        .ascii-text-container[data-variant="logo"] pre {
          background-image: linear-gradient(135deg, #ffffff 0%, #fbbf24 55%, #ffffff 100%);
        ...
        .ascii-text-container[data-variant="logo"] canvas {
          opacity: 0;
          pointer-events: none;
        }
      `}</style>
