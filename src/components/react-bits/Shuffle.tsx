...
const Shuffle: React.FC<ShuffleProps> = ({
  ...
  const baseTw = compact
    ? 'inline-block whitespace-nowrap leading-none will-change-transform'
  ...
  const classes = useMemo(
    () =>
      `${baseTw} ${hideUntilReady && !ready ? 'invisible' : 'visible'} ${className}`.trim(),
    [baseTw, hideUntilReady, ready, className]
  );
